...
Esta decisión va más allá de la entrega académica: permite a cualquier investigador auditar el pipeline de datos, replicar las 40 instancias experimentales con los mismos parámetros y comprobar las ecuaciones de mapeo hacia el Hamiltoniano de Ising. Con ello se contribuye, en la medida de lo posible, a un desarrollo más abierto frente al secretismo habitual en el sector \textit{Quantum Fintech}.
